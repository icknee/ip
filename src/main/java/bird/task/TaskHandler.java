...
public class TaskHandler {
    ...
    public static void markTaskAsDone(ArrayList<Task> taskList, String enteredTaskNumber, int taskCount) throws InvalidCommandException {
        int taskNumber;
        try {
    ...
    public static void markTaskAsNotDone(ArrayList<Task> taskList, String enteredTaskNumber, int taskCount) throws InvalidCommandException {
        int taskNumber;
        try {
            taskNumber = Integer.parseInt(enteredTaskNumber);
        } catch (NumberFormatException e) {
